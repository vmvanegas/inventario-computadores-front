...
export class LaptopFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.laptopForm = this.formBuilder.group({
      ...
      cpu: ["", [Validators.required, Validators.maxLength(100)]],
      ranura: ["", [Validators.required, Validators.maxLength(100)]],
      ram: ["", [Validators.required, Validators.maxLength(100)]],
      ssd_hdd: ["", [Validators.required, Validators.maxLength(100)]],
      responsable: ["", [Validators.required, Validators.maxLength(100)]],
      backup: ["", [Validators.required, Validators.maxLength(100)]],
      so: ["", [Validators.required, Validators.maxLength(100)]],
      estado: ["", [Validators.required, Validators.maxLength(100)]],
      modelo: ["", [Validators.required, Validators.maxLength(100)]],
      sn: ["", [Validators.required, Validators.maxLength(100)]],
