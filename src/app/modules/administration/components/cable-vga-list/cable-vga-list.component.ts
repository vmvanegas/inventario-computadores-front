...
@Component({
  selector: 'app-cable-vga-list',
  templateUrl: './cable-vga-list.component.html',
  styleUrls: ['./cable-vga-list.component.scss']
})
export class CableVgaListComponent implements OnInit {
  ...
  constructor(
    public service: CableVGAService,
  ...
  editItem(event){
    ...
    this.router.navigate(['/administracion/cablesvga/editar', event.id])
  }
